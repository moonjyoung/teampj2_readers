...
public class BookAPIController {
    ...
    @Operation(summary = "책 정보 추가", description = "aladin 검색 api를 통해 책 정보를 받아와서 추가합니다.",
        responses = {
    ...
    public ResponseEntity<ResponseBookInfoVO> addBookInfo(
        @Parameter(description = "알라딘 검색 api를 통해 데이터를 받아옵니다.") @RequestBody BookInfoAladinVO data
    ) {
